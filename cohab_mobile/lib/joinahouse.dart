...
class JoinAHouse extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Color(0xFFFFFFFF), // Bar color
        leading: IconButton(
          icon: Icon(Icons.arrow_back), // Back arrow (from LUCIDE)
          onPressed: () {
      ...
      body: Center( // Wrap the Column with Center
        child: Padding(
          padding: EdgeInsets.all(20), // Padding for the entire body
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 10), // Padding between text and text box
              Container(
                padding: EdgeInsets.symmetric(horizontal: 20), // Padding for text box
