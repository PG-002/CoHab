...
class _LocationTrackerPageState extends State<LocationTrackerPage> {
  ...
  List<Map<String, dynamic>> _userLocations = []; // List to store user locations
    ...
    return Scaffold(
      ...
      body: GoogleMap(
        ...
        markers: _userLocations.map((userLocation) {
          String names = userLocation['name'] ?? 'Unknown User';

          double latitude = userLocation['lat'] ?? 0.0;
          double longitude = userLocation['long'] ?? 0.0;

          LatLng position = LatLng(latitude, longitude);
          String markerId = '${names}_$latitude$longitude';
